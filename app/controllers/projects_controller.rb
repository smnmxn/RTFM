class ProjectsController < ApplicationController
  ...
  def branding_params
    params.require(:project).permit(:primary_color, :accent_color, :gradient_start_color, :title_text_color, :help_centre_title, :help_centre_tagline, :support_email, :support_phone, :dark_mode, :seo_indexing_enabled)
  end
