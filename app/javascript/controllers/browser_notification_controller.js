...
export default class extends Controller {
  static targets = ["toggle", "status", "testButton"]
  ...
  test() {
    ...
    new Notification("supportpages.io", { body: "This is a test notification", icon: "/icon.png" })
  }
  ...
  _updateUI() {
    ...
    if (perm === "granted") {
      ...
      if (this.hasTestButtonTarget) this.testButtonTarget.classList.remove("hidden")
    } else if (perm === "denied") {
