  ...
  module Github
    class AppService
      ...
      def generate_jwt
        ...
        Rails.logger.info "[Vcs::Github::AppService] Generating JWT for app_id=#{app_id}, key length=#{key_content.length}, starts with: #{key_content[0..26]}..."
        ...
        Rails.logger.error "[Vcs::Github::AppService] Failed to parse private key: #{e.message}"
        raise
      end
